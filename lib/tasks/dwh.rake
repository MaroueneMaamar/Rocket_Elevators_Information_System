...
#         user_id: User.offset(rand(User.count)).first.id  # ici   prend un id de la table Useres au hazard
#     }])
# end
...
#             user_id: User.offset(rand(User.count)).first.id, # ici user_id prend un id de la table user au hazard
#             adress_id: Adress.offset(rand(Adress.count)).first.id  # ici   prend un id de la table adresses au hazard
#         }])
#     end
...
#             customer_id: Customer.offset(rand(Customer.count)).first.id, # ici customer_id prend un id de la table user au hazard
#             adress_id: Adress.offset(rand(Adress.count)).first.id, # ici adress_id prend un id de la table user au hazard
#             user_id: User.offset(rand(User.count)).first.id # ici user_id prend un id de la table user au hazard
#         }])
#     end
...
#             building_id: Building.offset(rand(Building.count)).first.id, # ici Building_id prend un id de la table Building au hazard
#             employee_id: Employee.offset(rand(Employee.count)).first.id # ici employee_id prend un id de la table user au hazard
#         }])
#     end
...
#             information: Faker::IndustrySegments.industry,
#             battery_id: Battery.offset(rand(Battery.count)).first.id # ici Battery_id prend un id de la table Battery au hazard
#         }])
#     end
...
#                 information: Faker::IndustrySegments.industry,
#                 column_id: Column.offset(rand(Column.count)).first.id # ici Column_id prend un id de la table Column au hazard
#             }])
#     end   
  end
